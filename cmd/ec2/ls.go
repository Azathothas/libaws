...
func ec2Ls() {
    ...
    if args.JSON {
        ...
        output[*instance.InstanceId] = instanceOutput{
			Name:          lib.EC2NameColored(instance),
			Type:          *instance.InstanceType,
			State:         *instance.State.Name,
			ID:            *instance.InstanceId,
			Image:         *instance.ImageId,
			Kind:          lib.EC2Kind(instance),
			SecurityGroup: lib.EC2SecurityGroups(instance.SecurityGroups),
			Tags:          lib.EC2Tags(instance.Tags),
		}
        }
